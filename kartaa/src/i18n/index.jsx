...
const DICTIONARY = {
  fr: {
    ...
    'sub.f3': 'Facebook, TikTok, YouTube et Telegram sur votre profil',
    ...
    'free.f4': 'Instagram, LinkedIn, X, Snapchat, sites web et liens sans limite',
  ...
  en: {
    ...
    'sub.f3': 'Facebook, TikTok, YouTube and Telegram on your profile',
    ...
    'free.f4': 'Instagram, LinkedIn, X, Snapchat, websites and unlimited links',
